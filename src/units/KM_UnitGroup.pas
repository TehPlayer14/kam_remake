                      ...
                      begin
                        ...
                        begin
                          ...
                          begin
							...
							Members[I].Direction := KMNextDirection(OldDir);
			
							DirectionRotationDiff := GetDirModifier(NewDir, KMPrevDirection(OldDir)); //let's check if turning left is good idea
							if(DirectionDiff < DirectionRotationDiff) then
							Members[I].Direction := KMPrevDirection(OldDir);
			
                            //Members[I].Direction := fOrderLoc.Dir;
							if(Members[I].Direction <> fOrderLoc.Dir) then
								Members[I].SetActionStay(80, uaWalk); //Make sure the animation still frame is updated
							//exit;
                          end;
                        end
                        else
